...
type FilmmakersSectionProps = {
  mode: PortfolioMode
}

export function FilmmakersSection({ mode }: FilmmakersSectionProps) {
  ...
  return (
    <section
      ...
      className={`py-24 md:py-32 transition-colors duration-500 ${
        isArchitecture ? "bg-[#0f1419]" : "bg-[#161021]"
      }`}
    >
      <div className="max-w-6xl mx-auto px-6">
        ...
        >
          ...
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-sans font-normal text-[#f2f2f2] max-w-4xl mx-auto text-balance">
            {isArchitecture
              ? "Projetos reais de arquitetura com curadoria visual e linguagem contemporanea."
              : "Projetos reais de design com curadoria visual e narrativa de marca."}
          </h2>
